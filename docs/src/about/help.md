...
You can "watch" Nomage in GitHub (by clicking the "watch" button at the top right):
<https://github.com/CGuichard/nomage>. Select "Releases only" to receive notifications whenever
...
<https://github.com/CGuichard/nomage>. By adding a star you help Nomage gain more visibility,
