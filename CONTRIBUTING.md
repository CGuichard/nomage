...
```bash
git clone https://github.com/CGuichard/nomage.git
```
...
Open a [Bug Report](https://github.com/CGuichard/nomage/issues/new?template=bug_report.md)
...
Please create a [Feature Request](https://github.com/CGuichard/nomage/issues/new?template=feature_request.md)
